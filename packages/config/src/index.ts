...
export const baseEnvSchema = z.object({
  ...
  EVENTSUB_PROCESSING_INTERVAL_MS: positiveIntFromString(5_000),
  EVENTSUB_RECONCILIATION_INTERVAL_MS: positiveIntFromString(60_000),
  EVENTSUB_MAX_DELETIONS_PER_RUN: positiveIntFromString(500),
  EVENTSUB_MAX_CREATIONS_PER_RUN: positiveIntFromString(100),
